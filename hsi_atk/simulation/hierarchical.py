...
class Hierarchical:
    ...
    def __init__(self, name, ell_sma, bands=240, band_dist=2.072, copy=False, center=(0, 0), is_substructure=False,
                 labels=None):
        """
        Initializes hierarchical object. Meant to store collections of structures representing one object
    ...
    def gen_sub_structure(self, ell_sma, name=None, dist_center=(0, 0), bands=None):
        ...
        s_ell = Hierarchical(name, ell_sma, bands=bands, is_substructure=True)
...
class HierarchicalKSpect(Hierarchical):
    """
    HSI object to store data about image substructure and easily add or remove it
    """
    def __init__(self, name, ell_sma, bands=240, band_dist=20.72, copy=False, center=(0, 0), is_substructure=False, labels=None):
        super().__init__(name, ell_sma, bands, band_dist, copy, center, is_substructure, labels)
